...
<main>
   ...
   <section class="rt-main-post-section main-post-section-style-1 section-padding">
      <div class="container">
         <div class="row gutter-24">
            <?php $sql = mysqli_query($conn, "select * from `forms` WHERE `main`='1' ORDER BY id DESC");

            // $sql1 =mysqli_query($conn,"SELECT * FROM `catagorie` ");

            // $sql= mysqli_query($conn,"SELECT * FROM `user`");
            $row = mysqli_fetch_assoc($sql);
            $cat_id = $row['categorie_id'];
            //  $sql_a =mysqli_query($conn,"SELECT * FROM `catagorie` WHERE  $cat_id=id  ");

            //  $roww=mysqli_fetch_assoc($sql_a);
            ...
            <div class="col-xl-7 col-lg-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="800ms">
               <div class="rt-post-overlay rt-post-overlay-xl layout-1">
                  <div class="post-img">
                     <a href="front_post.php?id=<?php echo $id;?>" class="img-link"  >
                        <img src="media/post_image/<?php echo $image ?>" alt="post-xl_1" width="900" height="600">
                        
                     </a>
                  </div>
                  <div class="post-content">
                     <a href="life-style.html" class="fashion"><?php ?></a>
                     <h3 class="post-title bold-underline">
                        <a href="front_post.php">
                           <?php echo $title ?>
                        </a>
                     </h3>
                     <div class="post-meta">
                        <ul>
                           <li>
                              <span class="rt-meta">
                                 by <a href="author.html" class="name">
                                    <?php
                                    $query = mysqli_query($conn, "SELECT name FROM user where id=$created_by");
            ...
            <div class="col-xl-5 col-lg-6">
               <div class="row gutter-24">
                  <?php $sql = mysqli_query($conn, "select *from `forms` WHERE `main`='1' ORDER BY id DESC LIMIT 1,3");

                  while ($row = mysqli_fetch_assoc($sql)) {;

                     // <?php $sql = mysqli_query($conn, "select *from `forms` WHERE `main`='1' ORDER BY id DESC LIMIT 1,1");
                     // $row = mysqli_fetch_assoc($sql);
                     $image = $row['image'];
                     $created_at = $row['created_at'];
                     $title = $row['title'];
                  ...
                  ?>
                     ...
                     <div class="col-12 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="800ms">
                        <div class="rt-post post-md style-10">
                           <div class="post-img">
                              <a href="front_post.php?id=<?php echo $id?>">
                                 <?php
                                 //  $sql = mysqli_query($conn, "select *from `forms` WHERE `main`='1' ORDER BY id DESC LIMIT 1,1");
                                 // $row = mysqli_fetch_assoc($sql);
                                 // $image = $row['image'];
                                 ?>
                                 <img src="media/post_image/<?php echo $image ?>" alt="post" width="696" height="491">
                              </a>
                           </div>
                           <div class="post-content">
                              ...
                              ?>
                              <a href="life-style.html" class="food"><?php echo $by['name'] ?></a>
                              <h3 class="post-title">
   ...
   <section class="top-stories-style-1 section-padding motion-effects-wrap">
      <ul class="element-list d-none d-xl-block">
         <li class="motion-effects1"><img class="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="800ms" src="media/elements/element_2.png" alt="element_1" width="88" height="58"></li>
         <li><img class="wow fadeInDown" data-wow-delay="400ms" data-wow-duration="800ms" src="media/elements/element_3.png" alt="element_2" width="182" height="72"></li>
         <li><img class="wow fadeInRight" data-wow-delay="600ms" data-wow-duration="800ms" src="media/elements/element_4.png" alt="element_3" width="199" height="128"></li>
      </ul>
      <div class="container">
         <div class="row">
            <div class="col-12">
         ...
         <div class="row gutter-24">
            <?php $sql = mysqli_query($conn, "select *from `forms` WHERE `top_stories`='1' ORDER BY id DESC LIMIT 0,4");
            while ($row = mysqli_fetch_assoc($sql)) {;
            ...
            ?>
               ...
               <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="800ms">
                  <div class="rt-post-grid grid-meta">
                     <div class="post-img">
                        <a href="front_post.php?id=<?php echo $row['id'];?>">
                           <img src="media/post_image/<?php echo $row['image'] ?>" alt="post" width="551" height="431">
                        </a>
                     </div>
                     <div class="post-content">
                     <?php
                              ...
                              ?>
                        <a href="gaming.html" class="rt-post-cat-normal"><?php echo $by['name'] ?></a>
                        <h3 class="post-title">
                           <a href="single-post1.html">
                              <?php echo $row['title'] ?>
                           </a>
                           ...
                           <ul>
                              <li>
                                 <span class="rt-meta">
                                    by <a href="author.html" class="name">
                                       <?php
                                       $query = mysqli_query($conn, "SELECT name FROM user where id= '".$row['created_by']."'");
                                       $by = mysqli_fetch_assoc($query);
               ...
               <div class="featured-area-style-1 overflow-hidden">
                  ...
                  <div class="wrap mb--60">
                     <div class="featured-tab-title">
                        ...
                        <ul class="nav rt-tab-menu" id="myTab" role="tablist">
                           <li class="menu-item" role="presentation">
                              <a class="menu-link active" id="menu-1-tab" data-bs-toggle="tab" href="#menu-1" role="tab" aria-controls="menu-1" aria-selected="true"> World </a>
                           </li>
                           <li class="menu-item" role="presentation">
                              <a class="menu-link" id="menu-2-tab" data-bs-toggle="tab" href="#menu-2" role="tab" aria-controls="menu-2" aria-selected="false"> Travel </a>
                           </li>
                           <li class="menu-item" role="presentation">
                              <a class="menu-link" id="menu-3-tab" data-bs-toggle="tab" href="#menu-3" role="tab" aria-controls="menu-3" aria-selected="false"> Food </a>
                           </li>
                           <li class="menu-item" role="presentation">
                              <a class="menu-link" id="menu-4-tab" data-bs-toggle="tab" href="#menu-4" role="tab" aria-controls="menu-4" aria-selected="false"> Technology</a>
                           </li>
                        </ul><!-- end nav tab -->
                     </div>
                     ...
                     <div class="tab-content" id="myTabContent">
                                 ...
                                 <div class="rt-post-overlay rt-post-overlay-lg">
                                    <div class="post-img">
                                       <a href="single-post1.html" class="img-link">
                                          <img src="media/gallery/post-xl_2.jpg" alt="post-xl-2" width="900" height="600">
                                       </a>
                                    </div>
                                    <div class="post-content">
                                 ...
                                 <div class="row gutter-24">
                                    <div class="col-12">
                                       <div class="rt-post post-sm style-2">
                                          ...
                                          <div class="post-img">
                                             <a href="single-post1.html">
                                                <img src="media/gallery/post-sm_5.jpg" alt="post" width="143" height="110">
                                             </a>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-12">
                                       <div class="rt-post post-sm style-2">
                                          ...
                                          <div class="post-img">
                                             <a href="single-post1.html">
                                                <img src="media/gallery/post-sm_6.jpg" alt="post" width="143" height="110">
                                             </a>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-12">
                                       <div class="rt-post post-sm style-2">
                                          ...
                                          <div class="post-img">
                                             <a href="single-post1.html">
                                                <img src="media/gallery/post-sm_7.jpg" alt="post" width="143" height="110">
                                             </a>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-12">
                                       <div class="rt-post post-sm style-2">
                                          ...
                                          <div class="post-img">
                                             <a href="single-post1.html">
                                                <img src="media/gallery/post-sm_8.jpg" alt="post" width="143" height="110">
                                             </a>
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="tab-pane tab-item animated fadeInUp" id="menu-2" role="tabpanel" aria-labelledby="menu-2-tab">
                           <div class="row gutter-24">
                              <div class="col-lg-7">
                                 <div class="rt-post-overlay rt-post-overlay-lg">
                                    <div class="post-img">
                                       <a href="single-post1.html" class="img-link">
                                          <img src="media/gallery/post-xl_2.jpg" alt="post-xl_2" width="900" height="600">
                                       </a>
                                    </div>
                                    <div class="post-content">
                                       <a href="life-style.html" class="world">World</a>
                        ...
                        <div class="tab-pane tab-item animated fadeInUp" id="menu-3" role="tabpanel" aria-labelledby="menu-3-tab">
                           <div class="row gutter-24">
                              <div class="col-lg-7">
                                 <div class="rt-post-overlay rt-post-overlay-lg">
                                    <div class="post-img">
                        ...
                        <div class="tab-pane tab-item animated fadeInUp" id="menu-4" role="tabpanel" aria-labelledby="menu-4-tab">
                           <div class="row gutter-24">
                              <div class="col-lg-7">
                                 <div class="rt-post-overlay rt-post-overlay-lg">
                                    <div class="post-img">
                     ...
                     <div class="row gutter-10">
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="800ms">
                           <div class="rt-post-overlay rt-post-overlay-md">
                              <div class="post-img">
                                 <a href="single-post1.html" class="img-link">
                                    <img src="media/gallery/post-xl_4.jpg" alt="post-xl_4" width="900" height="600">
                                 </a>
                              </div>
                              <div class="post-content">
                                 <h3 class="post-title bold-underline">
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="800ms" data-wow-duration="800ms">
                           <div class="rt-post-overlay rt-post-overlay-md">
                              <div class="post-img">
                                 <a href="single-post1.html" class="img-link">
                                    <img src="media/gallery/post-xl_7.jpg" alt="post-xl_7" width="900" height="600">
                                 </a>
                              </div>
                              <div class="post-content">
                                 <h3 class="post-title bold-underline">
                        ...
                        <div class="subscribe-content">
                           ...
                           <form action="#" class="rt-contact-form subscribe-form rt-form">
                              <div class="rt-form-group">
                                 <input type="email" class="form-control rt-form-control" placeholder="E-mail *" name="email" id="email_1" data-error="Email field is required" required>
                              </div>
                     ...
                     <div class="row rt-gutter-10">
                        ...
                        <div class="col-6">
                           <div class="rt-post-grid post-grid-md grid-meta">
                              <div class="post-img">
                                 <a href="single-post1.html">
                                    <img src="media/gallery/post-grid-md_1.jpg" alt="post" width="343" height="250">
                                 </a>
                              </div>
                              <div class="post-content">
                        ...
                        <div class="col-6">
                           <div class="rt-post-grid post-grid-md grid-meta">
                              <div class="post-img">
                                 <a href="single-post1.html">
                                    <img src="media/gallery/post-grid-md_2.jpg" alt="post" width="343" height="250">
                                 </a>
                              </div>
                              <div class="post-content">
                        ...
                        <div class="col-6">
                           <div class="rt-post-grid post-grid-md grid-meta">
                              <div class="post-img">
                                 <a href="single-post1.html">
                                    <img src="media/gallery/post-grid-md_3.jpg" alt="post" width="343" height="250">
                                 </a>
                              </div>
                              <div class="post-content">
                                 <a href="life-style.html" class="rt-post-cat-normal">Fashion</a>
                        ...
                        <div class="col-6">
                           <div class="rt-post-grid post-grid-md grid-meta">
                              <div class="post-img">
                                 <a href="single-post1.html">
                                    <img src="media/gallery/post-grid-md_4.jpg" alt="post" width="343" height="250">
                                 </a>
                              </div>
                              <div class="post-content">
                                 <a href="gaming.html" class="rt-post-cat-normal">Music</a>
                        ...
                        <div class="col-6">
                           <div class="rt-post-grid post-grid-md grid-meta">
                              <div class="post-img">
                                 <a href="single-post1.html">
                                    <img src="media/gallery/post-grid-md_5.jpg" alt="post" width="343" height="250">
                                 </a>
                              </div>
                              <div class="post-content">
                                 <a href="life-style.html" class="rt-post-cat-normal">Fashion</a>
                        ...
                        <div class="col-6">
                           <div class="rt-post-grid post-grid-md grid-meta">
                              <div class="post-img">
                                 <a href="single-post1.html">
                                    <img src="media/gallery/post-grid-md_6.jpg" alt="post" width="343" height="250">
                                 </a>
                              </div>
                              <div class="post-content">
                                 <a href="gaming.html" class="rt-post-cat-normal">Music</a>
               ...
               <div class="wrap">
                  <div class="featured-tab-title">
                     ...
                     <ul class="nav rt-tab-menu" id="myTab-2" role="tablist">
                        <li class="menu-item" role="presentation">
                           <a class="menu-link active" id="menu-11-tab" data-bs-toggle="tab" href="#menu-11" role="tab" aria-controls="menu-11" aria-selected="true"> World </a>
                        </li>
                        <li class="menu-item" role="presentation">
                           <a class="menu-link" id="menu-22-tab" data-bs-toggle="tab" href="#menu-22" role="tab" aria-controls="menu-22" aria-selected="false"> Travel </a>
                        </li>
                        <li class="menu-item" role="presentation">
                           <a class="menu-link" id="menu-33-tab" data-bs-toggle="tab" href="#menu-33" role="tab" aria-controls="menu-33" aria-selected="false"> Food </a>
                        </li>
                        <li class="menu-item" role="presentation">
                           <a class="menu-link" id="menu-44-tab" data-bs-toggle="tab" href="#menu-44" role="tab" aria-controls="menu-44" aria-selected="false"> Technology</a>
                        </li>
                     </ul><!-- end nav tab -->
                  </div>
                  <!-- end featured-tab-title -->
                  ...
                  <div class="tab-content" id="myTabContent-2">
                        ...
                        <div class="row gutter-24">
                           ...
                           <div class="col-xl-4 col-lg-6">
                              <div class="rt-post-overlay rt-post-overlay-md">
                                 <div class="post-img">
                                    <a href="single-post1.html" class="img-link">
                                       <img src="media/gallery/post-xl_3.jpg" alt="post-xl-3" width="900" height="600">
                                    </a>
                                 </div>
                                 <div class="post-content">
                                    <a href="life-style.html" class="music">Music</a>
                              ...
                              <div class="post-grid-md-list gutter-24">
                                 <div class="item">
                                    <div class="rt-post post-md style-8">
                                       <div class="post-img">
                                          <a href="single-post1.html">
                                             <img src="media/gallery/post-md_4.jpg" alt="post" width="343" height="250">
                                          </a>
                                       </div>
                                       <div class="post-content">
                                          <a href="technology.html" class="rt-post-cat-normal">Technology</a>
                                 ...
                                 <div class="item">
                                    <div class="rt-post post-md style-8">
                                       <div class="post-img">
                                          <a href="single-post1.html">
                                             <img src="media/gallery/post-grid-md_7.jpg" alt="post" width="343" height="250">
                                          </a>
                                       </div>
                                       <div class="post-content">
                                 ...
                                 <div class="item">
                                    <div class="rt-post post-md style-8">
                                       <div class="post-img">
                                          <a href="single-post1.html">
                                             <img src="media/gallery/post-grid-md_8.jpg" alt="post" width="343" height="250">
                                          </a>
                                       </div>
                                       <div class="post-content">
                                          <a href="life-style.html" class="rt-post-cat-normal">Food</a>
                              ...
                              <div class="post-grid-md-list gutter-24">
                                 <div class="item">
                                    <div class="rt-post post-md style-8">
                                       <div class="post-img">
                                          <a href="single-post1.html">
                                             <img src="media/gallery/post-grid-md_9.jpg" alt="post" width="343" height="250">
                                          </a>
                                       </div>
                                       <div class="post-content">
                                          <a href="life-style.html" class="rt-post-cat-normal">Travel</a>
                                 ...
                                 <div class="item">
                                    <div class="rt-post post-md style-8">
                                       <div class="post-img">
                                          <a href="single-post1.html">
                                             <img src="media/gallery/post-grid-md_10.jpg" alt="post" width="343" height="250">
                                          </a>
                                       </div>
                                       <div class="post-content">
                                          <a href="technology.html" class="rt-post-cat-normal">Technology</a>
                                 ...
                                 <div class="item">
                                    <div class="rt-post post-md style-8">
                                       <div class="post-img">
                                          <a href="single-post1.html">
                                             <img src="media/gallery/post-grid-md_11.jpg" alt="post" width="343" height="250">
                                          </a>
                                       </div>
                                       <div class="post-content">
                                          <a href="life-style.html" class="rt-post-cat-normal">World</a>
                     ...
                     <div class="tab-pane tab-item animated fadeInUp  " id="menu-22" role="tabpanel" aria-labelledby="menu-22-tab">
                        <div class="row gutter-24">
                     ...
                     <div class="tab-pane tab-item animated fadeInUp  " id="menu-33" role="tabpanel" aria-labelledby="menu-33-tab">
                        <div class="row gutter-24">
                     ...
                     <div class="tab-pane tab-item animated fadeInUp  " id="menu-44" role="tabpanel" aria-labelledby="menu-44-tab">
                        <div class="row gutter-24">
   ...
   <div class="section subscribe-section-style-1">
      <div class="container">
         <div class="row  justify-content-evenly">
            ...
            <div class="col-lg-4 align-self-end wow fadeInLeft d-none d-lg-block" data-wow-delay="300ms" data-wow-duration="800ms">
               ...
               <div class="rt-subscribe-box">
                  ...
                  <form action="#" class="rt-contact-form subscribe-form-style-2">
                     <div class="rt-subs-group">
                        <input type="email" name="email" id="email_2" class="subscribe-form" placeholder="Your e-mail" data-error="Email field is required" required>
